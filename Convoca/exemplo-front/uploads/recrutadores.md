...
> Papéis: `TENANT_ADMIN`, `RECRUITER`. Ver [design-system.md](design-system.md). O login
> inicial compartilhado (splash + formulário de empresa) vive em [login.md](login.md) — gere-o
> primeiro para fixar o design system do projeto inteiro.
