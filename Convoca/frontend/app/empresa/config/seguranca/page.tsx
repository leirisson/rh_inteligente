      ...
      <div className="flex w-full items-start gap-7.5 px-8 pb-14 pt-7">
        ...
        <section className="min-w-0 flex-1">
          ...
          <div className="grid grid-cols-1 gap-4.5 xl:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_4px_16px_rgba(15,23,42,0.08)]">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_4px_16px_rgba(15,23,42,0.08)]">
              <div className="mb-3.5 flex items-center justify-between">
                ...
                <span className="cursor-pointer text-[12.5px] font-semibold text-danger transition-colors hover:text-red-700">
              ...
              {sessions.map((s, i) => (
                ...
                >
                  ...
                  {!s.current && (
                    <button className="cursor-pointer text-[12.5px] font-semibold text-danger transition-colors hover:text-red-700">
                      Encerrar
                    </button>
                  )}
                </div>
